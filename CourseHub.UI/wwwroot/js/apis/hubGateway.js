...
class RTCHandler {
    ...
    setupRTCPeerConnection = async (peer) => {
        var response = await fetch("https://wisneturn.metered.live/api/v1/turn/credentials?apiKey=e4a9d38fe472a32d0d56326457de005fd640");
        ...
        let connection = new RTCPeerConnection(rtcConfiguration);
    ...
    setupRTCPeerConnections = async (peers) => {
        for (let peer of peers)
            await this.setupRTCPeerConnection(peer);
    }
